...
- Filtro por rango de fechas (Desde / Hasta) más un botón para limpiar todos los filtros.
...
- **612 tuits estructurados** (612 capturas únicas en el índice CDX, todas descargadas sin errores).
- Rango temporal: **1 de marzo de 2025 al 16 de mayo de 2026**.
- Idiomas: 562 español, 15 meme/imagen, 11 inglés, 7 sin contenido lingüístico, 7 portugués, resto varios.
- Tipos: 201 originales, 162 citas, 203 respuestas, 46 retweets.
- 277 tuits con links externos.
- 122 etiquetas temáticas únicas, encabezadas por *Politics*, *Javier Milei*, *Argentina politics*, *Mauricio Macri*, *Political figures*.
